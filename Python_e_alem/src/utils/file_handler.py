...
def relatorio_completo_txt(alerta):
    ...
    """
    with open('data/relatorio_completo.txt', 'a', encoding='utf-8') as arquivo:
        arquivo.write('\n-=-=-=- Alerta Salvo -=-=-=-\n')
...
def relatorio_resumido_txt(alerta):
    ...
    Dados de entrada: lista alertas que contem todos os dados relevantes
    """
    with open('data/relatorio_resumido.txt', 'a', encoding='utf-8') as arquivo:
        risco = alerta['risco'].upper() if alerta['risco'] else 'Desconhecido'
...
def relatorio_json(alertas):
    ...
    try:
        ...
        try:
            with open('data/relatorio_pragas.json', 'r', encoding='utf-8') as arquivo:
        ...
        with open('data/relatorio_pragas.json', 'w', encoding='utf-8') as arquivo:
